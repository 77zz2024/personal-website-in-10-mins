      ...
      items: [
        {
          ...
          content: [
            "Troubleshot and identified performance bottleneck of large-scale distributed systems (239 indexers, 11 search heads) using profiling tools (flame graph, heap dump, etc.)",
            "Developed automated self-service benchmarking tools/infra (Python, Ansible, aiohttp, JumpSSH, etc.), adopted company-wide; proposed and implemented optimizations",
            "Designed and implemented performance benchmarks (network chaos, high-concurrency, longevity, etc.) for Splunk products",
            "Built a cost-monitoring Slack App (Flask) used by 150+ internal users, which calculated cloud infrastructure costs (AWS, GCP, Azure) and sent subscription-based alerts",
            "Engineered a customer insight AI App (Redis, LangGraph, FastMCP, pgvector, etc.), serving as a centralized monitoring hub for customer stacks with 1000+ DAU",
            "Developed APIs (FastAPI) with Okta auth to enable customer insight AI agents to integrate with internal AI platform as a skill",],
        },
        {
          ...
          content: [
            ...
            "Leveraged CI/CD (Jenkins) for deployment on AWS; used Kubernetes for pod management and Nexus/SonarQube for code analysis",
